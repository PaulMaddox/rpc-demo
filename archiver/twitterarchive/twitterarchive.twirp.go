...
/*
Package twitterarchive is a generated twirp stub package.
...
// ==============================
// TwitterArchive Protobuf Client
// ==============================

type twitterArchiveProtobufClient struct {
	urlBase string
	client  *http.Client
}

// NewTwitterArchiveProtobufClient creates a Protobuf client that implements the TwitterArchive interface.
...
func NewTwitterArchiveProtobufClient(addr string, client *http.Client) TwitterArchive {
	return &twitterArchiveProtobufClient{
		urlBase: urlBase(addr),
		client:  withoutRedirects(client),
	}
}

func (c *twitterArchiveProtobufClient) Create(ctx context.Context, in *CreateRequest) (*CreateResponse, error) {
	url := c.urlBase + TwitterArchivePathPrefix + "Create"
...
// ==========================
// TwitterArchive JSON Client
// ==========================

type twitterArchiveJSONClient struct {
	urlBase string
	client  *http.Client
}

// NewTwitterArchiveJSONClient creates a JSON client that implements the TwitterArchive interface.
...
func NewTwitterArchiveJSONClient(addr string, client *http.Client) TwitterArchive {
	return &twitterArchiveJSONClient{
		urlBase: urlBase(addr),
		client:  withoutRedirects(client),
	}
}

func (c *twitterArchiveJSONClient) Create(ctx context.Context, in *CreateRequest) (*CreateResponse, error) {
	url := c.urlBase + TwitterArchivePathPrefix + "Create"
	out := new(CreateResponse)
...
func (s *twitterArchiveServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// TwitterArchivePathPrefix is used for all URL paths on a twirp TwitterArchive server.
// Requests are always: POST TwitterArchivePathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const TwitterArchivePathPrefix = "/twirp/twitterarchive.TwitterArchive/"

func (s *twitterArchiveServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "twitterarchive")
	ctx = ctxsetters.WithServiceName(ctx, "TwitterArchive")
	...
	switch req.URL.Path {
	case "/twirp/twitterarchive.TwitterArchive/Create":
...
func (s *twitterArchiveServer) serveCreate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *twitterArchiveServer) serveCreateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
...
func (s *twitterArchiveServer) serveCreateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *twitterArchiveServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *twitterArchiveServer) ProtocGenTwirpVersion() string {
	return "v5.0.0"
}
